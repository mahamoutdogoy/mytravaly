...
echo "
	...
	<td><a href='edit_client_details.php?cid=".$_REQUEST['cid']."'>
	...
	<img src='img/profile.png' height='70px' width='70px' radius=50></img>
	...
	<td><br><a href='new_task.php?cid=".$_REQUEST['cid']."'>
  ...
  <strong><a href='completed_task.php?cid=".$_REQUEST['cid']."'>Click Here</a> To View Completed Task</strong>
</div>
	 ...
	 while($row2=mysqli_fetch_assoc($task_list))
	{
		echo "
			...
			<a href='edit_task.php?cid=".$_REQUEST['cid']."&tid=".$row2['TaskId']."'>
