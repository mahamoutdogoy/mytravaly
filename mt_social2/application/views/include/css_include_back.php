...
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>plugins/grid/grid_themes/default/easyui_custom.css"> <!-- custom css to make grid padding -->
...
<link href="<?php echo base_url();?>bootstrap/css/bootstrap-docs.css" rel="stylesheet" type="text/css" />
...
<link href="<?php echo base_url();?>css/skins/<?php echo $loadthemebody;?>.css" rel="stylesheet" type="text/css" />
<!-- iCheck -->
...
<!--Multiselect CSS -->
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>plugins/multiselect/multiple-select.css">
<!-- custom css -->
...
<style type="text/css">
label{color:#3C8DBC !important;font-weight: normal !important;}
</style>
