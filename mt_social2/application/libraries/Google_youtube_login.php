...
class Google_youtube_login{
	...
	public function set_login_button(){	
		...
		return "<a href='{$login_url}' class='btn btn-default'><i class='fa fa-plus blue'></i> Add New Channel</a>";
	}
	...
	public function blogger_login_button($redirectUrl){
		...
		// $redirectUrl = base_url()."video_matrix_live_event/blogger_login_callback";
		$client = $this->client;
		...
		return "<a href='{$login_url}' class='btn btn-default'><i class='fa fa-plus blue'></i> Add New Account</a>";
	...
	public function post_to_blogger($blogid,$title,$content,$acces_token){
