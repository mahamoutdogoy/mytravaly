...
<body>
	<h1 class=" jumbotron text-center text-uppercase text-white">Sign Up</h1>
	<div class="container">
		<form  method="post">
			<label for="fname">
				First Name
			...
			<select id="property" required class="custom-select form-control">
			...
			<br>
			<label for="email">
				Email <span class="small">(NOTE: This will be your user ID.)</span>
			</label>
			...
			<br>
			<br>
			<input type="checkbox" value="agree" required> I agree to the <a href="#">terms & conditions</a> and <a href="#">privacy policy</a>.
			<br>
			<br>
			<input type="submit" value="register" class="text-uppercase form-control text-white font-weight-bold" id="submit">
		</form>
		<br>
		<p>Already a member? Proceed to <a href="#">Login page</a></p>
	</div>
</body>
</html>
