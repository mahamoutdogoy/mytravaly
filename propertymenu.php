...
<div class="row ">
 ...
 <ul style=" color:#FF6F61;width: 100%;" class="nav unstyled-list ml-5 float-left" id="Div1" >
		  ...
		  <li  class="nav-item"><a class="btn-link " href="#">Rooms, Inventory, Tarrif</a></li>
		  <li class="nav-item"><a class="btn-link" href="">Photos</a></li>
		  <li class="nav-item"><a class="btn-link" href="#">Amenities</a></li>
		  ...
		  <li class="nav-item"><a class="btn-link" href="#">Bank Detail</a></li>
