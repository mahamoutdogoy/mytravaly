...
$query = "SELECT * FROM property_details WHERE country ='$location' OR city='$location' OR propertyname='$location'";
    ...
    <section class="mb-5">
      <div class="container">
        ...
        <ul class="list-inline pr-3">
          ...
          <li class="list-inline-item"><a style="color: #FF6F61;" class="social-icon " target="_blank" href="#">From <?php echo $_SESSION['check_in']; ?><i class="fas fa-arrow-circle-right"></i></a></li>
          <li class="list-inline-item"><a style="color: #FF6F61;" class="social-icon " >To <?php echo $_SESSION['check_out']; ?><i class="fas fa-arrow-circle-right"></i></a></li>
...
if(isset($_POST['filter_search'])){
  if(!empty($_POST['checked_list'])){
    foreach($_POST['checked_list'] as $all_type) {
      ...
      $query = "SELECT * FROM property_details WHERE propertytype='$all_type' AND property_price>='$_POST[filter_price]' AND property_price<=3000 AND country ='$location' OR city='$location' OR propertyname='$location'";
    }elseif($_POST['filter_price']==3000){
      $query = "SELECT * FROM property_details WHERE propertytype='$all_type' AND property_price>='$_POST[filter_price]' AND property_price<=5000 AND country ='$location' OR city='$location' OR propertyname='$location'";
    }elseif($_POST['filter_price']==5000){
     $query = "SELECT * FROM property_details WHERE propertytype='$all_type' AND property_price>='$_POST[filter_price]' AND property_price<=8000 AND country ='$location' OR city='$location' OR propertyname='$location'";
    }elseif($_POST['filter_price']==8000){
      $query = "SELECT * FROM property_details WHERE propertytype='$all_type' AND property_price>='$_POST[filter_price]' AND property_price<=10000 AND country ='$location' OR city='$location' OR propertyname='$location'";
    }elseif($_POST['filter_price']==10000){
      $query = "SELECT * FROM property_details WHERE propertytype='$all_type' AND property_price>='$_POST[filter_price]' AND property_price<=12000 AND country ='$location' OR city='$location' OR propertyname='$location'";
    }else{
      $query = "SELECT * FROM property_details WHERE propertytype='$all_type' AND property_price>='$_POST[filter_price]' AND country ='$location' OR city='$location' OR propertyname='$location'";
    }
    ...
    if($_POST['filter_price']==1000){
      $query = "SELECT * FROM property_details WHERE  property_price>='$_POST[filter_price]' AND property_price<=3000 AND country ='$location' OR city='$location' OR propertyname='$location'";
    }elseif($_POST['filter_price']==3000){
      $query = "SELECT * FROM property_details WHERE  property_price>='$_POST[filter_price]' AND property_price<=5000 AND country ='$location' OR city='$location' OR propertyname='$location'";
    }elseif($_POST['filter_price']==5000){
     $query = "SELECT * FROM property_details WHERE  property_price>='$_POST[filter_price]' AND property_price<=8000 AND country ='$location' OR city='$location' OR propertyname='$location'";
    }elseif($_POST['filter_price']==8000){
      $query = "SELECT * FROM property_details WHERE  property_price>='$_POST[filter_price]' AND property_price<=10000 AND country ='$location' OR city='$location' OR propertyname='$location'";
    }elseif($_POST['filter_price']==10000){
      $query = "SELECT * FROM property_details WHERE  property_price>='$_POST[filter_price]' AND property_price<=12000 AND country ='$location' OR city='$location' OR propertyname='$location'";
    }else{
      $query = "SELECT * FROM property_details WHERE  property_price>='$_POST[filter_price]' AND country ='$location' OR city='$location' OR propertyname='$location'";
    }
 ...
 ?>
          ...
          if($sorting1 OR $sorting2 OR $sorting3 OR $sorting4){
            if($sorting1){
              $query = "SELECT * FROM property_details WHERE country ='$location' OR city='$location' OR propertyname='$location' ORDER BY propertyname ";
            }elseif ($sorting2) {
             $query = "SELECT * FROM property_details WHERE country ='$location' OR city='$location' OR propertyname='$location' ORDER BY rating DESC ";
           }elseif($sorting3){
             $query = "SELECT * FROM property_details WHERE country ='$location' OR city='$location' OR propertyname='$location' ORDER BY property_price ";
           }else{
             $query = "SELECT * FROM property_details WHERE country ='$location' OR city='$location' OR propertyname='$location' ORDER BY star DESC ";
           }
