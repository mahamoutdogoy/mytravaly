...
<body>
	...
	<div class="container">
		<ul class="list-inline pr-3">
			...
			<li class="list-inline-item"><a style="color: #FF6F61;" class="social-icon " target="_blank" href="#"><?php echo $row1['country']; ?><i class="fas fa-arrow-circle-right"></i></a></li>
		...
		<p>
			...
			<ul class="list-inline">
				<li class="list-inline-item">
					<p><i class="fas fa-map-marker-alt" style="color: #FF6F61"></i><?php echo $row1['address']; ?></p>
				</li>
			</ul>
			...
			<div class="row">
				...
				<div class=" jumbotron col-sm-4">
					...
					<div class="jumbotron h-50" style="background-color: white">
						<h5>Offer::</h5>
						<p><b>Delux Room</b>
							<button style="float: right;background-color: #FF6F61;border-radius: 10px;color: ">&#x20B9 <?php echo $row1['property_price']; ?>/night</button>
							<p>refoundable</p>
			...
			<ul class="row list-inline mt-5" style="background-color:#FF6F61 ">
				<li class="col-sm-2 list-inline-item"><p><b>Check-In date</b>
					...
					<input type="date" id="checkin_date" class="form-control" width="300" onchange="" name="check_in"  value="<?php if(isset($_POST['check_in'])){
echo $_SESSION['check_in'];
			...
			<li class="col-sm-2 list-inline-item"><p><b>Check-Out date</b>
				...
				<input type="date" id="datepicker2" class="form-control" width="300" value="<?php if(isset($_POST['check_in'])){
echo $_SESSION['check_out'];
}?>" name="check_out" onchange="" />
			
			</p></li>
			<li class="col-sm-2 list-inline-item"><b>Rooms:</b>
				<select class="browser-default custom-select" name="rooms">
					<option selected value="<?php if(isset($_POST['rooms'])){
echo $_SESSION['rooms'];
...
echo $_SESSION['rooms'];
				...
				<li class="col-sm-3 list-inline-item"><b>Adults:</b>
						...
						<select class="browser-default custom-select" onchange="this.form.submit()" name="adults1">
							<?php if(isset($_POST['adults1'])){
								?>
							<option  value="<?php echo $_SESSION['people']; ?>" selected>
								<?php echo $_SESSION['people']; ?></option>
						<?php  }
								else {?>
					...
					<li class="col-sm-2 list-inline-item"><b>Children:</b>
						<select class="browser-default custom-select" name="children" onchange="this.form.submit()">
							<option selected value="<?php if(isset($_POST['children'])){
echo $_SESSION['children'];
}?>"><?php echo $_SESSION['children']; ?></option>
							<option value="1">1</option>
							<option value="2">2</option>
							<option value="3">3</option>
						</select></li>	
				...
				<div class="container">
					<br>  <h3 class="text-center">Confirm booking details and proceed Your payment </h3>
					<hr>
