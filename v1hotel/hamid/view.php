...
<body>
	...
	<div class="container">
		<ul class="list-inline pr-3">
			...
			<li class="list-inline-item"><a style="color:  #FF6F61;" class="social-icon " target="_blank" href="#"><?php echo $row1['propertyname']; ?><i class="fas fa-arrow-circle-right"></i></a></li>	
		...
		<p>
			...
			<ul class="list-inline">
				<li class="list-inline-item">
					<p style="color:  #FF6F61;"><i class="fas fa-map-marker-alt" style="color: #FF6F61"></i><?php echo $_SESSION['adress']; ?></p>
				</li>
			</ul>
				...
				<div class="container">
					...
					<div class="card">
						<table class="table table-hover shopping-cart-wrap">
							...
							$_SESSION['room_type']= $row_type['room_name'];
							$_SESSION['inventory_id'] = $row_inventory['room_sub_id'];
							...
							$row_reservation = mysqli_fetch_array($reservation_result);
								...
								<input type="submit" class="btn btn-outline-danger btn-round" onclick='.$path.' value="Book now" name='.$row_type['room_name'].' >
								</form>
								</td>
								</tr>
						...
						$tax_result = mysqli_query($connect,$tax);
