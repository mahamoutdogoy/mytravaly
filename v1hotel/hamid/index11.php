...
<head>
    ...
    <style>
        ...
        <?php include 'header.php'; ?>
            ...
            <div class="container  pl-1 pr-1   pb-5 mt-5" style="text-align: center;background-color:  #FF6F56; opacity: 0.9;border-radius: 20px">
                <div class="row  " >
                    <div class="col-sm-2"></div>
                    <div class="col-sm-8" >
                        <h2 class="text-light" style="text-align: center;">Make Reservation</h2>
                        </div>
                        <div class="col-sm-2"></div>
                    </div>
                    <div class="row mt-5">
                            ...
                            <form method="POST" action="">
                                <div class="row row_service" >
                                    <div class="mr_style col-sm-4">
                                        ...
                                        <input type="text" name="location" class="form-control textboxstyle" placeholder="Location/search accomodation" required="true" alert="City name" style="border-radius: 5px">
                                    </div>

                                    <div class="mr_style col-sm-4">
                                        <i class="fa fa-calendar text-danger" aria-hidden="true"></i>
                                        <input type="text" name="check_in" class="form-control textboxstyle"  id="checkin_date" placeholder="Check in" autocomplete="off" style="border-radius: 5px">
                                    </div>
                                    <div class="mr_style  col-sm-4">
                                        <i class="fa fa-calendar text-danger" aria-hidden="true"></i>
                                ...
                                <div class="row row_service">
                                    ...
                                    <div class="mr_style col-sm-2 ">
                                        <select name="people" id="" class="browser-default  " style="padding:10px 20px 0 80px;margin:10px 0 0 0;border-radius: 5px">
                                    ...
                                    <div class="mr_style col-sm-2 ">
                                        <select name="rooms" id=""  class="browser-default " style="padding:10px 3px 0 80px;margin:10px 0 0 0;border-radius: 5px">
                                    ...
                                    <div class="col-sm-4 " style="">
                                        ...
                                        <select name="children"   class="browser-default " style="padding:10px 130px 0 100px;margin:10px 0 0 0;border-radius: 5px">
                                    ...
                                    <div class="col-sm-4 ">
                                        <input type="submit" onclick="return Validate();" style="border-radius: 5px" class="form-control textboxstyle btn btn-success mt-3"  value="Search" name="checkout">
                                    </div>
                                </div>
        ...
        <div class="container">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-12" style="background-color: #FF6F61">
