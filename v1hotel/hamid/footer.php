	...
	<section id="footer">
		<div class="container">
			...
			<div class="row copy_right">
				<div class="text-center col-md-12 col-12" style="padding:10px 10px 3px 5px;">
					<ul class="list-unstyled list-inline social text-center">
						...
						<li class="list-inline-item"><a href="#"><i class="fa fa-instagram fa-lg"></i></a></li>
						<li class="list-inline-item"><a href="#"><i class="fa fa-google-plus fa-lg"></i></a></li>
			...
			<div class="row"  style="padding-bottom:0px;">
				<div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
					...
					<p style="margin:5px  -15px 10px -15px;color: black; font-size: 18px;">&copy; 2019 Travely Travel & Hospitality  LLP. All right Reserved <mark>.ESTD.2017</mark>
