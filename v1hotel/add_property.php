		...
		<script>
			$(document).ready(function() {
                        	...
                        	$("#second2").slideUp("slow", function(){
                        		$("#first2").slideDown("slow");
									...
									<form action="#" class="login_form float-right">
										...
										<div class="">
											<i><span>Dont have account ?</span> <a href="#" class="signup" id="signup2"> Sign up</a></i>
										</div>
									...
									<form action="#" class="login_form float-right">
										...
										<div class="form-group">
											<div class="input-group mb-2">
												...
												<input type="email" class="form-control" id="email" name="email" placeholder="Property Name" required>
											</div>
										</div>
										<div class="form-group">
											<div class="input-group mb-2">
												...
												<input type="email" class="form-control" id="email" name="email" placeholder="Owner Name" required>
											</div>
										</div>
										...
										<div class="form-group">
											<div class="input-group mb-2">
												...
												<input type="Password" class="form-control" id="pwd" name="pwd" placeholder="Confirm your password" required>
											</div>
										</div>
										...
										<div class="">
											<i><span>have an account ?</span> <a href="hotellogin.php" class="signin" id="signin22222" target="_blank"> Sign In</a></i>
										</div>
					...
					<div class="container mt-5 mb-5	">
						<div class="row">
							<br/>
							<div class="text-center col-md-3 mb-5" style="left:400px;">
								...
								<form action="search.php"  method="POST">
									<div class="row">
										...
										<div class="mr_style field_section">
											...
											<input type="text" autocomplete="off"  name="checkin_date" class="form-control textboxstyle"  id="checkin_date" placeholder="Check in">
										</div>
										<div class="mr_style field_section">
											<i class="fa fa-calendar text-danger" aria-hidden="true"></i>
											<input type="text" name="checkout_date" autocomplete="off" class="form-control textboxstyle" id="checkout_date" placeholder="Check out">
									</div>
									...
									<div class="mr-4 col-md-4 mr_style ">
										...
										<div class="mr-4 col-md-4   ">
 											<input type="submit" onclick="return Validate();" class="form-control textboxstyle btn btn-success"  value="Search">
										</div>
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											<div class="input-group mb-2">
												...
												<input type="text" class="form-control  " id="location" name="location" placeholder="choos your trip destination" required>
											</div>
										</div>
			...
			<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBCtXJY98z16Kj_aNXdkjtTbYul4j-EkmE&libraries=places"></script>
