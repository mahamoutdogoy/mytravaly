...
<!-- style="background-color:#f15025 -->
<nav  aria-label="breadcrumb" style=color:white;>

  <ol class="breadcrumb "  style="background-color:#f15025; margin-right:30px; margin-left: 30px"; >
   <!--  <center><li class="breadcrumb-item active" aria-current="page" ><h3>User Profile</h3></li></center> -->

    <center><li class="breadcrumb-item active" aria-current="page" ><h3>Welcome To Your Profile <?php echo $_SESSION['user']['username'] ?></h3></li></center>
  </ol>
    ...
    <div class="col-md-4 ">      
        <div class="portlet light profile-sidebar-portlet bordered">
            <div class="profile-userpic">
               <center> <img src='<?php echo $image_src; ?>' style='width:300px;height:490px; ce' alt=person class='img-fluid rounded-circle img-thumbnail mr-3'/></center>
        ...
        <div class="portlet light bordered">
            <div class="portlet-title tabbable-line">
                <div class="caption caption-md">
                    ...
                    <span class="caption-subject font-blue-madison bold uppercase">Your Information</span>
                </div>
            </div>
                        ...
                        <div role="tabpanel" class="tab-pane active" id="home">
                            <form>
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="username" id="inputName" placeholder=" <?php echo $_SESSION['user']['username'];?> "readonly>
                              ...
                              <div class="form-group">
                                <label for="exampleInputEmail1">Email address</label>
                                 <input type="email" class="form-control" name="email" id="exampleInputEmail1" placeholder=" <?php echo $_SESSION['user']['email'];?> " readonly> 

                                
                              </div>
                              <div class="form-group">
                                <label for="exampleInputPassword1"> Current Password</label>
                                <input type="password" class="form-control" name="curpass" id="curpassid" placeholder="Current Password" onclick="return showhide1();">
                              </div>
                              <div class="form-group">
                                <label for="exampleInputPassword1"> New Password</label>
                                <input type="password" class="form-control" name="newpass" id="newpassid" placeholder="New Password" onclick="return showhide2();">
                              </div>
                              <div class="form-group">
                                <label for="exampleInputPassword1"> Confirm Password</label>
                                <input type="password" class="form-control" name="confpass" id="confpassid" placeholder="Confirm Password" onclick="return showhide3();">
                              </div>
                              <!-- <div class="form-group">
                                  ...
                                  <input type="file"  name="ufile" required="">
                                    ...
                                    <form method="post" action="image.php" enctype='multipart/form-data'>
                                      ...
                                      <!-- input type='submit' value='Save name' name='but_upload'> -->
                                       ...
                                       <button type="submit" class="btn btn-primary" name="but_upload">Update</button>
...
<?php
    if (isset($_POST['update'])) {
        ...
        $pw_sql = "SELECT passwd from users WHERE userid=".$_SESSION['user']['userid'];
        ...
        if ($curpass!==$pw_row['passwd']) {
            ...
            $pw_sql = "UPDATE users SET passwd='$confpass' WHERE userid=".$_SESSION['user']['userid'];
