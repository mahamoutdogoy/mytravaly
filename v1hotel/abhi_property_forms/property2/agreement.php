...
session_start();
	...
	$query=mysqli_query($con,"select * from agreement where agreement_id=".$_SESSION['agreement_id']);
	$value=mysqli_fetch_array($query);
	if(empty($value))
	{
		$path="location:agreement_page.php";
...
<body background="">
	<form>
		<div class="sticky float-right" >
			<input type="button" class="btn btn-primary " style="width: 200px" name="" onclick="onClick(this)" value="Print"  />
		</div>
		<div align="justify" style="padding-left: 15px;padding-top: 15px;padding-bottom: 15px; font-family: 'Times New Roman'">
		<div style="width:95%;padding-left: 50px;" >
			<center><h2>MYTRAVALY AGREEMENT</h2></center>
			<br><br>
			<div > <p style="text-align: left;">
				<h3>The Hotel agreement:</h3>
				This hotel agreement (the "agreement") is effective ,<b><?php echo "$value[effective_date]"; ?></b>
				<br><br><table>
					...
					<tr style="border-top: solid 1px;">
						...
						<td style="border-left:solid  2px;padding-left: 20px;padding-top: 20px"><b><?php echo "$value[hotel_name]";?></b> (the "Hotel"), a company organized and existing under the laws of the 
				of <?php echo "$value[state]";?>, with its head office located at <b><?php echo "$value[location]"; ?></b>
			</td>
					</tr>
				</table>
				</p>
					  </div>
			<p style="font-size:12px;"><h3>Preamble</h3>
	...
	Attention: Partner Management Department </pre></b>
			<h4>if to : </h4><b ><pre style="font-family:'Segoe UI'">
	the Hotel 
	<?php echo "$value[if_to_hotelName]"?>
	<?php echo "$value[if_to_address]"?>
	Attention:	<?php echo "$value[individual_Name]"?>
	...
	<p id="p19"><h4><li>Counterparts</h4><br>
		...
		<div class="row">
			<div class="col-sm-6"  style="padding-left: 100px"> 
				...
				&ensp;&ensp;&ensp;&ensp;&ensp;<img src="\property2\Mytravaly images\seal.jpg"/><br><br>
				authorised stamp <br>&ensp; and signature 
					
			 </div>
			<div class="col-sm-6"  style="padding-left: 100px">
				<h4>Second Party :</h4><br><br>
				&ensp;&ensp;&ensp;&ensp;&ensp;<?php echo"<img src='data:image/jpeg;base64,".base64_encode($value['signature'])."' style='width:120px;height:95px;' class='img'  onclick='choseImg(this)'/>"; ?><br><br>
