			...
			<div class="card col-md-8" style="margin-left: 40px;" >
				...
				<div class="card-body">
					<form action="" method="post">
							...
							<td><input id="confpassid" type="password" name="confpass" class="form-control" required placeholder="Confirm"></td><td><i class="fas fa-eye-slash" style="margin-left: -40px;margin-top: 10px;" onclick="return showhide3();"></i></td></tr>
						</table>
