...
<?php
	...
	if(isset($_POST['create_user'])){
		...
		$ins_sql = "INSERT INTO users (name, email, passwd, username, mobile, designation, department, status, role, hotelid, dateofcreation) VALUES('$user', '$email', '$pass', '$username', '$mobile', '$desid', '$depid', '$status', '$role','$hotelid', '$date')";
		  echo gettype($ins_sql);
