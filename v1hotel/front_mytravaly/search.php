...
if(isset($_POST['world'])){
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        <h6 style="text-transform:uppercase">'.$row['propertyname'].'<i class="text-warning ml-4 fa fa-star"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i></i></h6>
        <p>'.$row['address'].'</p>
        <p><strong style="color: green"><i class="fas fa-wifi"></i>Free Wifi<span class="mr-4"><i class="mr-4"></i><i class="fas fa-ban"></i>Free Cancellation</span></strong></p>
...
if(isset($_POST['night'])){
  ...
  <li class=mt-5 list-inline-item" style="float: right;"><i style="color: green"><?php echo $rating; ?>!</i><p class="mr-1 ml-1" name="review" style="background-color: green;border-radius: 10px;color: white" align="center"><b>'.$row['rating'].'</b></p></li>
