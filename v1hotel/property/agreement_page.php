<?php
	...
	$query=mysqli_query($con,"select * from agreement where property_id='121'");
	$value=mysqli_fetch_array($query);
	
	if(!empty($value))
	{
		$_SESSION['agreement_id']=$value['agreement_id'];
...
<body >
	<form action="agreement_backend.php" method="POST" enctype="multipart/form-data">
	...
	<div id="div_view">
		...
		<div style="width:95%;padding-left: 50px;" >
			...
			<div > <p style="text-align: left;">
				...
				This hotel agreement (the “agreement”) is effective ,<b><input type="date" name="effective_date"></b>
				<br><br><table>
				...
				of <input type="text" name="state_name" placeholder="State Name" required="" /> , with its head office located at <textarea placeholder="Adress" name="head_office_address" rows=2 cols=40></textarea>
			</td>
					</tr>
				</table>
				</p>
	...
	<p id="p19"><h4><li>Counterparts</h4><br>
		...
		<div class="row">
			...
			<div class="col-sm-6"  style="padding-left: 100px">
				...
				<img  alt="signature" id="profile-img-tag" style="display: none;" height="70px" width="200px"  ><br><br>
