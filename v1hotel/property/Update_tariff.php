...
$_SESSION["property_id"]=$_POST['property'];
...
//echo $room;
$rowSQL = mysqli_query($con, "select max_occupancy from rooms_detail where user_id='$session_user' and property_id='$property' and room_id='$room_id'");
...
if (isset($_POST['new_price'])) {
	...
	//$property=$_POST['property'];
	//$room=$_POST['room'];
	//echo "kiran".$_SESSION["property"]."kumar";
	//$arr=explode("-", $room);
	//$room_id1=$arr[0];
	//$meal_plan1=$arr[1];
	//echo $room_id;
...
$propertyrooms_offers=$property."_rooms_offers";
...
/*mysqli_query($con,"CREATE TABLE IF NOT EXISTS `$propertyrooms_offers` (
  ...
  `infantprice` double NOT NULL DEFAULT '0'
		...
		mysqli_query($con,"INSERT INTO rooms_offers(user_id,property_id,room_id,p_r_id,start_date,end_date,meal_plan,singleprice,doubleprice,tripleprice,person4price,person5price,person6price,person7price,person8price,person9price,person10price,person12price,person13price,person14price,person15price,extrapersonprice,extrachildprice,infantprice) VALUES ('$session_user','$_SESSION[property_id]','$_SESSION[room_id]','$_SESSION[property_id]$_SESSION[room_id]$_SESSION[meal_plan]','$begin','$to','$_SESSION[meal_plan]','$trp1','$trp2','$trp3','$trp4','$trp5','$trp6','$trp7','$trp8','$trp9','$trp10','$trp12','$trp13','$trp14','$trp15','$extraperson','$extrachild','$infant')");
...
<form action="" method="post">
	...
	<div align="center" style="background: #f15025;margin: 0 auto;height: 10%; width:75%;padding: 10px;border-radius: 75px;">
		...
		<label style="font-size: 20px;color: green">
			...
			<input type="radio" checked="true" id="radio4" name="t" value="" onclick="window.location='Update_tariff.php';" ><b><a href="#" style="text-decoration: none;color: white">Update Tariff</a></b>
		</label>
	</div>


	<div class="row p-3" style="font-size: 18px;text-align: center;">
...
<div class="modal fade"  tabindex="-1" role="dialog" id="myModal">
  <div class="modal-dialog modal-lg"    role="document">
	...
	<div class="col-12" style="" id="div2" >
...
<table id="table2"  class="table table-dark table-hover">
			...
			<tr id="1">
				<td>Single</td>
				<td><input type="number" name="" autocomplete="off"  id="t1" class="s1 t1" required /></td>
				<td><input type="number" name="" autocomplete="off" id="t2" class="s2 t1" /></td>
			...
			<tr id="2">
				<td>Double</td>
				<td><input type="number" name="" autocomplete="off" id="t3" class="s1 t2" /></td>
				<td><input type="number" name="" autocomplete="off"id="t4" class="s2 t2" /></td>
			...
			<tr id="3">
				<td>Triple</td>
				<td><input type="number" name="" autocomplete="off" class="s1 t3" id="t5" /></td>
				<td><input type="number" name="" autocomplete="off" class="s2 t3" id="t6" /></td>
			...
			<tr id="4">
				<td>Person 4</td>
				<td><input type="number" name="" autocomplete="off" class="s1 t4" id="t7"/></td>
				<td><input type="number" name="" autocomplete="off" class="s2 t4" id="t8" /></td>
			...
			<tr id="5">
				<td>Person 5</td>
				<td><input type="number" name="" autocomplete="off" class="s1 t5" id="t9" /></td>
				<td><input type="number" name="" autocomplete="off" class="s2 t5" id="t10" /></td>
			...
			<tr id="6">
				<td>Person 6</td>
				<td><input type="number" name="" autocomplete="off" id="t11" class="s1 t6"/></td>
				<td><input type="number" name="" autocomplete="off" id="t12" class="s2 t6"/></td>
			...
			<tr id="7">
				<td>Person 7</td>
				<td><input type="number" name="" autocomplete="off" id="t13" class="s1 t7"/></td>
				<td><input type="number" name="" autocomplete="off" id="t14" class="s2 t7"/></td>
			...
			<tr id="8">
				<td>Person 8</td>
				<td><input type="number" name="" autocomplete="off" id="t15" class="s1 t8"/></td>
				<td><input type="number" name="" autocomplete="off" id="t16" class="s2 t8"/></td>
			...
			<tr id="9">
				<td>Person 9</td>
				<td><input type="number" name="" autocomplete="off" id="t17" class="s1 t9"/></td>
				<td><input type="number" name="" autocomplete="off" id="t18" class="s2 t9"/></td>
			...
			<tr id="10">
				<td>Person 10</td>
				<td><input type="number" name="" autocomplete="off" id="t19" class="s1 t10"/></td>
				<td><input type="number" name="" autocomplete="off" id="t20" class="s2 t10"/></td>
			...
			<tr id="11">
				<td>Person 11</td>
				<td><input type="number" name="" autocomplete="off" id="t21" class="s1 t11"/></td>
				<td><input type="number" name="" autocomplete="off" id="t22" class="s2 t11"/></td>
			...
			<tr id="12">
				<td>Person 12</td>
				<td><input type="number" name="" autocomplete="off" id="t23" class="s1 t12"/></td>
				<td><input type="number" name="" autocomplete="off" id="t24" class="s2 t12"/></td>
			...
			<tr id="13">
				<td>Person 13</td>
				<td><input type="number" name="" autocomplete="off" id="t25" class="s1 t13"/></td>
				<td><input type="number" name="" autocomplete="off" id="t26" class="s2 t13"/></td>
			...
			<tr id="14">
				<td>Person 14</td>
				<td><input type="number" name="" autocomplete="off" id="t27" class="s1 t14"/></td>
				<td><input type="number" name="" autocomplete="off" id="t28" class="s2 t14"/></td>
			...
			<tr id="15">
				<td>Person 15</td>
				<td><input type="number" name="" autocomplete="off" id="t29" class="s1 t15"/></td>
				<td><input type="number" name="" autocomplete="off" id="t30" class="s2 t5"/></td>
			...
			<tr>
				<td>Extra Person</td>
				<td><input type="number" autocomplete="off" name="stxt" class="s1" id="ep1"/></td>
				<td><input type="number" autocomplete="off" name="stxt" class="s2" id="ep2"/></td>
			...
			<tr>
				<td>Extra Child</td>
				<td><input type="number" autocomplete="off" name="stxt" class="s1" id="ec1"/></td>
				<td><input type="number" autocomplete="off" name="ectxt" class="s2" id="ec2"/></td>
			...
			<tr>
				<td>Infant</td>
				<td><input type="number" autocomplete="off" name="stxt" class="s1" id="i1"/></td>
				<td><input type="number" autocomplete="off" name="itxt" class="s2" id="i2"/></td>
	...
	<tr style="background:#ff6f61;opacity: 0.8;text-align: center;" >
     ...
     <div class="modal-footer">
		...
		<div class='wrapper'>
		    ...
		    <input type="text" id="from" style="width:150px" name="from" required="true">
		    <label class="label1" for="to">to:</label>
		    <input type="text" id="to" style="width:150px" name="to" required="true">
		</div>
