...
while($row1 = mysqli_fetch_array($result)) { ?>
            ...
            <td>
            	...
            	?></b></div> 
            	<div class="row" style="width: 100%"> <table   class="table table2" >
              ...
              echo "</tr>";     
              	...
              	<td>Occupancy</td>
              		<td><input type="button" value="Next Property" onclick="window.location="photo.php";"></td>
              		<td><table id="text2"><tr><td>hh</td></tr></table></td>
              		<td>P3</td>
              		<td>P4</td>
              		<td>P5</td>
              		<td><input type="button" value="Next Property" onclick="paginateTable("test2", 1);"></td>
              		</tr>';
