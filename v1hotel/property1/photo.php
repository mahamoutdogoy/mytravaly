...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="mt-5" style="background-color:#f15025;">
           ...
           &emsp; <table cellspacing="10" cellpadding="10" >
            ...
            <td>
              <select name="room" id="room" onchange="" style="width:270px;border-radius: 1rem;text-align: center;height: 35px" required>
