...
<div class="flexigrid" style='width: 100%; padding:15px' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div class="pDiv" style="padding:0 15px 15px 15px;border:1px solid #ccc;border-top:0">
		<br>
		<div style="border-top:1px solid #ccc;">
			<div class="pDiv2" style="display: block; width: 100%;">
			</div>
			<div class="pGroup">
			...
			<div class="pGroup">
				<span class="pcontrol"><?php echo $this->l('list_page'); ?> <input name='page' type="text" value="1" size="4" id='crud_page' class="crud_page" style="border-radius:0 !important;border:1px solid #ccc !important;">
