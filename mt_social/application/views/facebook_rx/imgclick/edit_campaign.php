	...
	<div class="col-xs-12 padding-20">
		<div class="box box-primary">
			<div class="box-header ui-sortable-handle padding-20" style="cursor: move;">
				...
				<h3 class="box-title"><?php echo $this->lang->line("edit campaign"); ?></h3>
				<!-- tools box -->
			...
			<div class="box-body padding-20">
				<form action="#" enctype="multipart/form-data" id="auto_poster_form" method="post">
					...
					<div class="form-group col-xs-12 col-md-6" style="padding:0 5px 0 0">
						...
						<input placeholder="<?php echo $this->lang->line('Schedule Time'); ?>" value="<?php echo $xdata_campaign[0]['schedule_time'];?>" name="schedule_time" id="schedule_time" class="form-control datepicker" type="text"/>
					</div>
					...
					<div class="form-group col-xs-12 col-md-6" style="padding:0 0 0 5px">
						...
						echo form_dropdown('time_zone',$time_zone_list,$xdata_campaign[0]['time_zone'],' class="form-control" id="time_zone" required'); 
						?>
					</div>	
					<div class="clearfix"></div>
					<br><br>
					...
					<div class="box-footer" style="padding:15px 0">
						<button class="btn btn-primary btn-lg" id="submit_post" name="submit_post" type="button"><i class="fa fa-pencil"></i> <?php echo $this->lang->line("edit campaign"); ?></button>
					</div>
					<br>
		...
		$("#image_url_upload").uploadFile({
		 ...
		 $(document.body).on('click','#submit_post',function(){ 
			...
			$("#response_modal").modal();
			  ...
			  $.ajax({
			   type:'POST' ,
			   url: base_url+"imgclick/edit_campaign_action",
			   data: queryString,
			   dataType : 'JSON',
			   // async: false,
			   cache: false,
			   ...
			   {  		         
					...
					$("#submit_post").html('<i class="fa fa-pencil"></i> <?php echo $this->lang->line("edit campaign")?>');    
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><i class="fa fa-pencil"></i> <?php echo $this->lang->line("edit campaign")?></h4>
			</div>
