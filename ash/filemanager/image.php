...
$create_user_folder = CreateUserFolderIfNotExist();
				...
				<div class="col-md-12" style="margin-top: 20px;">					
					...
					<div class="tabbable tabs-left">
						<ul class="nav nav-tabs"  role="tablist" id="myTab">
							<li><a href="#tab1" role="tab" data-toggle="tab"><span class="glyphicon glyphicon glyphicon-picture"> </span> <?php e_lang('insert_from_url'); ?></a></li>
				...
				<div>
							<form class="form-horizontal" action="" method="">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 pdf-fields hidden">
...
<div class="col-md-12 image-fields hidden">
...
<img id="preview" src="<?php if(isset($source) && $source != '') : echo $source; else : echo PREVIEW_SOURCE; endif; ?>" alt="<?php e_lang('preview'); ?>" style="margin: 2px; padding: 5px; max-width: 450px; overflow:hidden; max-height: 250px; border: 1px solid rgb(192, 192, 192);"/>
    
<video id="videobox" width="340" height="240" style="display: none" controls>
  <source id="videosource" src="" type="video/mp4">
Your browser does not support the video tag.
</video>

<audio id="audiobox" style="display: none" controls>
...
<!-- <?php if($extension == 'mp3') : ?>
	...
	<audio id="audiobox" controls>
	  <source id="audiosource" src="<?php echo $source; ?>" type="audio/mpeg">
	Your browser does not support the audio element.
	</audio>
        ...
        add: function (e, data) {
           ...
           // Append the file name and file size
            ...
            if(data.result.success == true){
        		data.context.remove();
        		var fileInfoArray = data.result.file.split("/");
        		var file_name = fileInfoArray[fileInfoArray.length - 1];
        		if(data.result.is_pdf == 1){
        			$("#uploaded-images").append('<div class="item-b" style="text-align: center"><a style="margin: 0px; margin-right: 27px;" href="" class="pdf-thumbs" title="' + data.result.file + '" rel="' + data.result.file + '" data-icon="' + data.result.icon + '"><img src="' + data.result.icon + '" class="img-thumbnail" width="130" height="90"></a><div class="clearfix"></div><p class="caption">'+ file_name +'</p></div>');
        		}else{
        			$("#uploaded-images").append('<div class="item-b" style="text-align: center"><a style="margin: 0px; margin-right: 27px;" href="" class="img-thumbs" title="' + data.result.file + '" rel="' + data.result.file + '"><img src="timthumb.php?src=' + encodeURIComponent(data.result.file_encrypt) + '&w=130&h=90" class="img-thumbnail" width="130" height="90"></a><div class="clearfix"></div><p class="caption">'+ file_name +'</p></div>');
        		}
        	}else{
        		data.context.empty();
...
</select>&nbsp;&nbsp;&nbsp;<!--<a href="" title="refresh folders list" id="refresh-dirs"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span></a>-->
</p>
</div>
