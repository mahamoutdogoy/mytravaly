...
<head>
	...
	<section id="welcome" style="z-index: 10000; border-bottom: 3px solid orange;">
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class="text text-center">
						<br><a href="<?php echo base_url(); ?>"><img src="<?php echo base_url();?>assets/images/logo.png" style="max-height: 70px;"></a>
					</div>
					<br>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-xs-12" >
					<div class="left-content">
						<h1>
							<span style="color: #b33833">Privacy Policy</span>
						</h1>
						...
						<p><span style="font-weight: bold;">How does This APP use login information? </span></p>
