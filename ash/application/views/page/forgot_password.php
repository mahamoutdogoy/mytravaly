...
<style>#wait{padding-top:20px;padding-left:10px;}</style>
  ...
  <div class="row row-centered">
    ...
    <div class="account-wall" id='recovery_form'> 
        ...
        <div class="form-group">
          <button type="button" id="submit" style="margin-top:20px" class="btn btn-primary btn-lg"><i class="fa fa-send"></i> <?php echo $this->lang->line("send recovery data"); ?></button>
          <span id='wait' ></span>  
        </div>      
    </div>
  </div>
