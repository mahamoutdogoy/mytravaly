         ...
         <div class="box-body">
          ...
          <div class="form-group">
             ...
             <table class="table table-bordered table-condensed table-hover table-striped" style="width:auto;">
              <tr>
               <td colspan="3"><input  id="all_modules" type="checkbox"/> <font color="blue">&nbsp;&nbsp;&nbsp;&nbsp;<b><?php echo $this->lang->line("All Modules"); ?></b></font> [<?php echo $this->lang->line("0 means unlimited");?>]</td>
              </tr>
               <?php                   
                    ...
                    {  
                     echo "<tr>";    
                      ...
                      echo "<td style='padding-left:10px'>".$limit."</td><td><input type='".$type."' value='".$xmonthly_val."' min='0' class='form-control' style='width:70px;' name='monthly_".$module['id']."'></td>";
