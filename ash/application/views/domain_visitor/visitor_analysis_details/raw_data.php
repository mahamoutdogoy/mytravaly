<div role="tabpanel" class="tab-pane" id="raw_data">
	<div id="raw_data_success_msg" class="text-center" ></div>	
		...
		<div class="col-xs-10 col-md-10 col-lg-10" style="margin-right: -23px;">
			...
			<div class="form-group">
				...
				<div class="input-group">
					...
					<input type="text" class="form-control pull-right reservation" id="raw_data_date" />
				</div><!-- /.input group -->
			</div><!-- /.form group -->
		</div>
		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 style="color: blue; word-spacing: 3px;" class="box-title"><i class="fa fa-codepen"></i> <?php echo $this->lang->line("Raw data report");?> (<span id="raw_data_from_date"></span> - <span id="raw_data_to_date"></span>)</h3>
				...
				<div class="box-body chart-responsive">
					<div id="raw_data_name" class="table-responsive">
