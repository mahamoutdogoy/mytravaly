<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	$lang['list_page'] 				= 'পৃষ্ঠা নং';	
	$lang['list_paging_of'] 		= 'মোট পৃষ্ঠা ';
	$lang['list_displaying']		= 'মোট {results} টি ফলাফলের মধ্যে {start} থেকে {end} পর্যন্ত দেখানো হচ্ছে';
	...
	$lang['list_delete'] 			= 'ডিলিট';
	$lang['list_edit'] 				= 'সম্পাদন';	
	...
	$lang['form_edit'] 				= 'সম্পাদন';
	$lang['form_back_to_list'] 		= 'তালিকায় ফিরে যান'; 
	$lang['form_update_changes'] 	= 'সম্পাদন';
	$lang['form_cancel'] 			= 'বাতিল';	
	$lang['form_update_loading'] 	= 'অপেক্ষা করুন, ডাটা সম্পাদন হচ্ছে...';
	$lang['update_success_message'] = 'আপনার তথ্য সফলভাবে সম্পাদন করা হয়েছে.';	
	$lang['form_go_back_to_list'] 	= 'লিস্ট এ ফিরে যান';
	
	$lang['form_add'] 				= 'যোগ করুন';
	$lang['insert_success_message'] = 'আপনার তথ্য সফলভাবে ডাটাবেসে সংরক্ষিত হয়েছে।';
	$lang['form_or']				= 'অথবা';
	...
	$lang['form_upload_delete'] 	= 'ডিলিট';
	$lang['form_button_clear'] 		= 'পরিস্কার';	
	
	$lang['delete_success_message'] = 'আপনার তথ্য সফলভাবে ডাটাবেস থেকে ডিলিট করা হয়েছে।';
	$lang['delete_error_message'] 	= 'আপনার তথ্য ডাটাবেস থেকে ডিলিট হয় নি।';
	...
	$lang['alert_delete']			= 'আপনি কি নিশ্চিত যে আপনি এই রেকরডটি ডিলিট করতে চান?';
	...
	$lang['string_delete_file'] 	= "ফাইল ডিলিট করার পদ্ধতি";
	$lang['string_progress'] 		= "অগ্রগতি: ";
	$lang['error_on_uploading'] 	= "একটি ত্রুটি ঘটেছে আপলোড এর সময়.";
	$lang['message_prompt_delete_file'] = "আপনি কি নিশ্চিত যে আপনি এই ফাইলটি ডিলিট করে চান?";
	...
	$lang['list_export'] 	= "ডাউললোড";
	$lang['list_print'] 	= "প্রিন্ট";
	$lang['minimize_maximize'] = '্মিনিমাইজ/ম্যাক্সিমাইজ';	

	/* Added in version 1.4 */
	$lang['list_view'] = 'বিস্তারিত';
