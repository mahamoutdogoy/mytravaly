...
<div class="row header" id="myHeader" style="background: #555;">
 ...
 <ul style=" color:#FF6F61;width: 100%;font-size: 13px" class="nav unstyled-list ml-5 float-left" id="Div1" >

 

	    

	  	  <li class="nav-item"><a style="border:solid red 1px; border-radius:5px; padding: 5px;margin-top: 10px;" id="hide" class="btn-link mr-5 active  "  onclick="switchVisible();" href="#"><b>switch to tour operator</b></a></li>

	  	  <li class="nav-item"><a  class="btn-link " href="index.php"><b>Property Details</b></a></li>

		  <li  class="nav-item"><a class="btn-link " href="Rooms_dashboard.php"><b>Rooms, Inventory, Tarrif</b></a></li>
		  ...
		  <li class="nav-item"><a class="btn-link" href="#"><b>Agreement</b></a></li>
