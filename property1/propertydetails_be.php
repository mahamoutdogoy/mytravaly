<?php
   ...
   //$session_user=$_SESSION['user_id'];
     ...
     $query3="INSERT INTO reservationmanager(ownerid,resname,resemail,resphone,citylife,nightlife,destination,food,heritage) VALUES ('$val','$_POST[resmanname]','$_POST[resmanemail]','$_POST[resmanphone]','$_POST[citylife]','$_POST[nightlife]','$_POST[destination]','$_POST[food]','$_POST[heritage]')";
      ...
      {
         $query5 = "INSERT INTO propertydetails (user_id,ownerid,property_name,propertytype,chainname,establishment,currency,description) VALUES ('abhi','$val','$_POST[pname]','$_POST[ptype]','$_POST[chain]','$_POST[establishment]','$_POST[currency]','$_POST[description]')";
      }
      else
      {

         $query5 = "INSERT INTO propertydetails (user_id,ownerid,property_name,propertytype,chainname,establishment,currency,checkin,checkout,description) VALUES ('abhi','$val','$_POST[pname]','$_POST[ptype]','$_POST[chain]','$_POST[establishment]','$_POST[currency]','$_POST[intime]','$_POST[outtime]','$_POST[description]')";
      }
