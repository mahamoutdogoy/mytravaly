            ...
            <li class="nav-item mr-4">
                ...
                <li class="nav-item mr-4">
                    ...
                    <li class="nav-item mr-5">
                        ...
                        <a href="#" class="nav-link">
                         <!-- <?php echo($my_file!=NULL)?'<img src="images/'.$my_file.'" >' :'' ;?>   -->
                   ...
                   // while ($row = mysqli_fetch_array($result)) {
                    ...
                    <li class="nav-item">
                        <a href="../logout.php" class="nav-link" data-toggle="modal" data-target="#sign-out">
 ...
 <div class="container-fluid">
    ...
    <div class="row">
        ...
        <ul class="navbar-nav flex-column">
            ...
            <li class="nav-items">
                <a href="profitmaker.php" class="nav-link">
