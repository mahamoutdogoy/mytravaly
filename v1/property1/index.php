...
<script type="text/javascript">
    ...
    else if (document.myForm.owneremail.value == "")
    {
    ...
    else if (document.myForm.manemail.value == "")
    {
...
<body >
    <div class="row">
      <div class="col-md-3">
       ...
       <div class="col-md-8">
    <form action="propertydetails_be.php" method="POST" class="col-lg-5" name="myForm" style="margin-top:40px;margin-left: 200px;">
            ...
            <div id="div1" >
                        <table cellpadding="20"  id="t1" style="">
                                <tr style='background-color:#ff6f61;width: 10px;height: 10px;'>
                ...
                <tr>
                        <td>
                                ...
                                <input type="radio" name="change" id="change" style="width: 60px;height: 30px;" class=" form-control">
                ...
                <tr>
                        ...
                        <td>
                               <!-- <textarea name="description" rows="8" cols="55" maxlength="200">
                       ...
                       <tr>
                           ...
                           <td>
                               <input type="submit"  name="nxt1" id="nxt1" value="next" onclick="next1()"  style='width:150px;border-radius:20px;' 
        ...
        <div id="div2" style="display: none;">
         <table   cellpadding="20" id="t2" >
                 <tr style='font-family: Britannic Bold;font-size:20;background-color:#ff6f61;width: 20px;height: 20px;'>
                <td align="center" colspan="4">
                        <b >Address</b>
                </td>
         </tr>
                ...
                <tr>
                        ...
                        <td>
                                <input type="text"  name="zpcode" class="  form-control" required style="width:450px;" />
                        </td>
                        <tr>
                           <td>
                           ...
                           <td>
                               <input type="submit"  name="nxt2" value="next" onclick="next2()" style='width:150px;border-radius:20px;' 
                               class="btn btn-success  form-control"/>
        ...
        <table  cellpadding="20" id="t3" >
         ...
         <tr>
            ...
            <td>
                <input type="text"  name="ownerid" class="  form-control" required style="width:450px;" />
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                <input type="text"  name="ownerphone" class="  form-control" required style="width:450px;" />
            </td>
        </tr>
                    <tr>
                           <td>
                           ...
                           <td>
                               <input type="submit"  name="nxt3" value="next" onclick="next3()" style='width:150px;border-radius:20px;' 
                               class="btn btn-success form-control"/>
    ...
    <table   cellpadding="20" id="t4" >
        ...
        <tr>
            ...
            <td>
                <input type="text"  name="manphone" class="  form-control" required style="width:450px;"/>
            </td>
        </tr>
        <tr>
                           <td>
                           ...
                           <td>
                               <input type="submit"  name="nxt4" value="next" onclick="next4()" style='width:150px;border-radius:20px;' 
                               class="btn btn-success form-control"/>
    ...
    <table  cellpadding="20" id="t5" >
        ...
        <tr>
            ...
            <td>
                <input type="text"  name="resmanphone" class="  form-control" required style="width:450px;" />
            </td>
        </tr>
        <tr style='font-family: Britannic Bold;font-size:20;'>
                <td align="center" colspan="4">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" style="border-radius: 10px;" name="citylife" value="citylife" class=" btn btn-success form-control"   style="width:450px;">
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="checkbox"  name="nightlife" value="nightlife" class="  form-control"  style="width:450px;" />
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="checkbox"  name="destination" value="destinationwedding" class="  form-control" style="width:450px;" />
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="checkbox"  name="food" value="food" class="  form-control"   style="width:450px;"/>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="checkbox"  name="heritage" value="heritageandculture" class="  form-control"  style="width:450px;" />
            </td>
        </tr>
     ...
     <table  id="t6" style="margin-bottom: 50px;">
         <tr>
             <td>
                ...
                <td>         
                <input type="submit"  value="SAVE" name="submit" style='width:150px;border-radius:20px;background-color:#ff6f61;'
                class="btn btn-success form-control"/>
            </td>
