...
<div class="row header" id="myHeader" style="background:#fff;"> 
 ...
 <ul style=" color:#FF6F61;width: 120%;font-size: 12px" class="nav unstyled-list ml-5 float-left" id="Div1" >
	  	  ...
	  	  <li class="nav-item"><a  class="btn-link " href="propertydetails.php"><b>Property Details</b></a></li>
