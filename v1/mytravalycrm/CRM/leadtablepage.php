             ...
             <?php if($page==1)
                                {
									...
									<a href='leadtablepage.php?page=$nextpage'>
								...
								{
									$prevpage=$page-1;
                                    echo "<a href='leadtablepage.php?page=$prevpage'>
									...
									<button class='btn btn-warning' style='width:70px'>$page</button>
									</b><a href='leadtablepage.php?page=$nextpage'>
