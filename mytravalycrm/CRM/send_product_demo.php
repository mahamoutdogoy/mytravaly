...
if($_POST['email'] && $_POST['desc'] && $_POST['price'])
{
	...
	$message .= "<div style='box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2); max-width: 300px; margin: auto; text-align: center; font-family: arial;'> <img src='".$_POST['img_src']."' alt='Hotel Photo'  style='width:100%'>";
