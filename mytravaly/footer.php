	...
	<section id="footer">
		<div class="container">
			<div class="row text-center text-xs-center text-sm-left text-md-left">
				<div class="col-xs-12 col-sm-2 col-md-2 ml-2 mt-2">
					<h6>Contact</h6>
			...
			<div class="row col-12 copy_right">
			<div class=" text-center mt-3 pl-5 col-md-6 col-sm-6 col-6 col-xs-6">
				<img src="images/payment.png" with="50" height="30" alt="">
				</div>
				<div class="text-center col-md-6 col-6" style="padding:10px 10px 3px 5px;">
			...
			<div class="row"  style="padding-bottom:0px;">
				<div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
					...
					<p style="margin:5px  -15px 10px -15px;color: black;">&copy; 2019 Travely Travel & Hospitality  LLP. All right Reserved <mark>.ESTD.2017</mark>
